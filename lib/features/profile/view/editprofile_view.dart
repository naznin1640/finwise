                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text("Account Settings",style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, fontFamily: "Poppins"),),
                          ),
                          Padding(
                          ...
                          Padding(
                           padding: const EdgeInsets.only(left: 35, right: 35,top: 17, bottom: 12),
                         ...
                         Padding(
                           ...
                           child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("Turn Dark Theme", style: TextStyle(
                                fontFamily: "Poppins",
                                fontSize: 15,
                                fontWeight: FontWeight.w500
                              ),),
